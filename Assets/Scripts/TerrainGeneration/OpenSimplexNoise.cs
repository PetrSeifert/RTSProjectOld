...
public static class OpenSimplex2
{
    ...
    const long SEED_OFFSET_4D = 0xE83DC3E0DA7164DL;
    ...
    const double FALLBACK_ROTATE_3D = 2.0 / 3.0;
    ...
    */
    ...
    static readonly float[] GRADIENTS_3D;
    static readonly float[] GRADIENTS_4D;
    static OpenSimplex2()
    {
